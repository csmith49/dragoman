...
val thing : t -> Value.t -> Thing.t option
val relations : t -> relation_key list
val relation : t -> relation_key -> Relation.t option

(* actually used accesses *)
val things_idx : t -> (Value.t * Thing.t) list

(* construction and manipulation *)
val empty : t
val add_thing : t -> Value.t -> Thing.t -> t
val add_relation : t -> relation_key -> Relation.t -> t

val add_attribute_to_thing : t -> Value.t -> Thing.attribute -> Value.t -> t